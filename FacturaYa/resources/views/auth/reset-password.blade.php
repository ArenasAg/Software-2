...
<div class="login-container">
    ...
    <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="form-floating">
            <input type="email" class="form-control" id="emailInput" name="email" placeholder="nombre@ejemplo.com" value="{{ old('email', $request->email) }}" required autofocus>
        ...
        <button type="submit" class="btn btn-login mt-3">Restablecer Contraseña</button>
    </form>
</div>
@endsection
